...
{
    public GameObject Startobj, TargetObj;
    ...
    public void Start()
    {
        startPos = Vector2Int.CeilToInt(Startobj.transform.position);
        targetPos = Vector2Int.CeilToInt(TargetObj.transform.position);
    }
